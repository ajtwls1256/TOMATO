    			...
    			IMP.request_pay({
    			    ...
    			    if ( res.success ) {
    			       ...
    			       var item = ${item};
    			       	...
    			       	var	name			=rsp.name;
    			       	var	buyerName		=rsp. buyer_name
    			       	var	buyerEamil		=rsp.buyer_email
    			       	var buyerTel		=rsp.buyer_tel
    			       	var buyerAddr		=rsp.buyer_addr
    			       	var paidAtnumber	=rsp.paid_atnumber
    			       			
    			       	$.ajax({
    			       		url:"/sellPageTo",
    			       		type:"get",
    			       		data:{item:item,impUid:impUid,merchantUid:merchantUid,payMethod:payMethod,status:status,
    			       			name:name,buyerName:buyerName,buyerEamil:buyerEamil,buyerTel:buyerTel,buyerAddr:buyerAddr, paidAtnumber: paidAtnumber},
	    			       	success : function(){
	    						location.href=""
	    					},
	    					error : function(){
