...
public class Item {
	...
	public Item(int itemNo, int memberNo, String itemName, String itemMainCategory, String itemSubCategory,
			int itemPrice, Date itemEnrollDate, String itemState, int readcount, int favoriteCount, String itemContent,
			int itemAmount, int itemDeliveryNy, String itemDealRegion, String itemThumFilename, String itemThumFilepath,
