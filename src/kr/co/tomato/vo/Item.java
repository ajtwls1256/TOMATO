...
public class Item
{
    ...
    public Item(int rnum, int itemNo, int memberNo, String itemName,
            String itemMainCategory, String itemSubCategory, int itemPrice,
            Date itemEnrollDate, String itemState, int readcount,
            String itemContent, int itemAmount, int itemDeliveryNY,
            String itemDealRegion, String itemThumFilename,
