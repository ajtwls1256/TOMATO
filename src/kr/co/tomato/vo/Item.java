...
public class Item {
		...
		public Item(int rnum, int itemNo, int memberNo, String itemName, String itemMainCategory,
				String itemSubCategoty, int itemPrice, Date itemEnrollDate, String itemState, int readcount,
