...
<!-- 			
 ...
 -->
 	  		...
 	  		<div class="con1">
		  		...
		  		<div class="md-btn">
		  			<button class="md-btn-prev" data-btn="0"><img src="/img/prev.png" class="md-btn-prev-img"></button>
		  			<button class="md-btn-next" data-btn="1"><img src="/img/next.png" class="md-btn-next-img"></button>	  			
		  		</div>	
	  		</div> 
...
<!-- 7 생활가구 -->		  			
	...
	$(document).ready(function(){
		...
		function moveSlider(){ 
			...
			if(check == 0){
				$('.md-slider1').animate({left:'+='+$md+"px"},300,slideEnd);
			}else if(check==1){
				$('.md-slider1').animate({left:'-='+$md+'px'},300,slideEnd);
			} 
		}
		function slideEnd(){
			var nowLeft = $('.md-slider1').position().left;
			...
			if(nowLeft<=end){ 
				$('.md-slider1').animate({left:end});console.log('left:end');
			}else if(nowLeft>0){
				$('.md-slider1').animate({left:0});console.log('left:0');
			}
		}
